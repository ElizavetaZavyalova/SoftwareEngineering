...
class EmailSender:
    ...
    def send_welcome_email(self, email:str, user: str):
        print("Sending email: " + email + " welcome " + user)

    def send_change_password_email(self, email:str, user:str):
        print("Sending email: " + email + " change_password_for: " + user)
