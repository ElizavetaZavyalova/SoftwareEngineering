...
passenger_repository = PassengerRepository(url=os.getenv("DATABASE_PASSENGER_URL", "postgresql://root:root@localhost:5502/passengers"))
...
##########################################################
@app.post("/passenger/trip/{id}/connect", tags=[ConnectTripsController._CONNECTING_TRIPS], summary="Подключение текущего пассажира к поездке по id")
