...
from adding_trip.entity.driver.rest.driver import Driver, DriverInfo
...
def update_model(model: Driver_DB, user: Driver) -> bool:
    ...
    return model
def create_driver_info(model: Driver_DB) -> DriverInfo:
    if model is None:
        return None
    return DriverInfo(account_id=model.id,
